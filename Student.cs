...
namespace CSCI1250_FinalProject
{
    internal class Student : IEquatable<Student>
    {
        ...
        public Student(string firstName, string middleName, string lastName, string eNumber, string concentration)
        {
        ...
        public Student(string firstName, string middleName, string lastName, string eNumber,
        string major, string concentration, int compCredHours, int compCredPoints, bool filedForGraduation)
        {
            this.firstName = firstName;
            this.middleName = middleName;
            this.lastName = lastName;
        ...
        public override string ToString()
        {
            ...
            if (middleName == "")
            {
                msg += $"Information About Student: {this.firstName} {this.lastName}\n";
            }
            else
            {
                msg += $"Information About Student: {this.firstName} {this.middleName[0]}. {this.lastName}\n";
            }
            msg += "-------------------------------------------------\n";
            msg += $"E#: {this.eNumber}\n";
            msg += $"Major: {this.major}\n";
            msg += $"Concentration: {this.concentration}\n";
            msg += $"Computing Credit Hours: {this.compCredHours}\n";
            msg += $"Computing Credit Points: {this.compCredPoints}\n";
            msg += $"Graduation Filing Status: {this.filedForGraduation}\n";
            return msg;
        }
        ...
        public string GetGraduationStatus(int creditHours, double gpa, bool filedForGrad)
        {
            ...
            {
                graduationStatus += "Graduation Status: Ready\n";
            ...
            {
                graduationStatus += "Graduation Status: Not Ready\n";
                graduationStatus += "Qualifications for Graduation:\n";
                graduationStatus += "-------------------------------------\n";
        ...
        public string GetFullMajor(string major)
        {
            ...
            {
                fullMajor += "Major: Computer Science\n";
            }
            else
            {
                fullMajor += "Major: Error - Improper Major Received\n";
            }
            return fullMajor;
        }
        ...
        public string GetFullConcentration(string concentration)
        {
            ...
            {
                fullConcentration += "Concentration: Computer Science\n";
            }
            else if (concentration.ToUpper() == "CSMN")
            {
                fullConcentration += "Concentration: Cybersecurity and Modern Networks\n";
            }
            else if (concentration.ToUpper() == "IT")
            {
                fullConcentration += "Concentration: Information Technology\n";
            }
            else if (concentration.ToUpper() == "IS")
            {
                fullConcentration += "Concentration: Information Systems\n";
            }
            else
            {
                fullConcentration += "Concentration: Error - Improper Concentration Received\n";
            }
