...
namespace CSCI1250_FinalProject
{
    internal class Student : IEquatable<Student>
    {
        ...
        public override string ToString()
        {
            ...
            if (middleName == "")
            {
                msg += $"Information About Student: {this.firstName} {this.lastName} ({GetClassification(compCredHours)})\n";
            }
            else
            {
                msg += $"Information About Student: {this.firstName} {this.middleName[0]}. {this.lastName} ({GetClassification(compCredHours)})\n";
            }
            msg += "-------------------------------------------------\n";
            msg += $"E#: {this.eNumber}\n";
